...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white py-12 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
        ...
        <div className="lg:col-span-2 flex flex-col space-y-4">
          <div className="flex items-center">
            ...
            <span className="text-2xl font-bold text-gray-800">
              Fund<span className="text-green-600">Onion</span>
            </span>
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between space-y-6 sm:space-y-0">
