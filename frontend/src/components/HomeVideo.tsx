  ...
  return (
    <section className="py-12 flex flex-col gap-6">
      ...
      <div className="flex justify-center">
        <div className="relative bg-[url('/video-thumb.jpg')] bg-cover bg-center w-full max-w-2xl rounded-xl aspect-[2/1] bg-gray-900 bg-opacity-10 flex justify-center items-center">
          <div
