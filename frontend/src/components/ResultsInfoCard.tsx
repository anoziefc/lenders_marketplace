    ...
    return (
      ...
      ">
                ...
                {result && result?.content?.lenders_list[0]&& result?.content?.lenders_list[0].lender_name ? <ResultsSummaryCard
                    ...
                    total_lenders={result.content.lenders_list.length}
                /> : <NoResultsSection/>}
                ...
                <div
                    ...
                    {/* Image of the man */}
                    <div className="h-full w-full aspect-square overflow-hidden bg-top">
                        <Image src={"/person-result.avif"} fill alt="" className="object-cover" style={{height: "100%", width: "100%"}}/>
                    </div>
