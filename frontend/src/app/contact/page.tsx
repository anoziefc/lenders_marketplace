      ...
      <div className=" bg-white font-inter flex items-center justify-center p-4 sm:p-6 md:p-8">
        <div className="w-full max-w-6xl bg-white rounded-xl shadow-lg overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="flex-1 bg-green-900 p-6 sm:p-8 md:p-10 flex items-center justify-center relative">
            ...
            <div className="absolute bottom-0 right-0 w-48 h-48 bg-yellow-400 rounded-tl-full opacity-50 transform translate-x-1/2 translate-y-1/2"></div>
            <div className="absolute top-0 left-0 w-32 h-32 bg-green-700 rounded-br-full opacity-50 transform -translate-x-1/2 -translate-y-1/2"></div>
